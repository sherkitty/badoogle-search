...
class Config:
    def __init__(self, **kwargs):
        ...
        self.url = os.getenv('BADOOGLE_CONFIG_URL', '')
        self.lang_search = os.getenv('BADOOGLE_CONFIG_SEARCH_LANGUAGE', '')
        self.lang_interface = os.getenv('BADOOGLE_CONFIG_LANGUAGE', '')
        self.style = os.getenv(
            'BADOOGLE_CONFIG_STYLE',
            open(os.path.join(app_config['STATIC_FOLDER'],
                              'css/variables.css')).read())
        self.block = os.getenv('BADOOGLE_CONFIG_BLOCK', '')
        self.block_title = os.getenv('BADOOGLE_CONFIG_BLOCK_TITLE', '')
        self.block_url = os.getenv('BADOOGLE_CONFIG_BLOCK_URL', '')
        self.country = os.getenv('BADOOGLE_CONFIG_COUNTRY', '')
        self.tbs = os.getenv('BADOOGLE_CONFIG_TIME_PERIOD', '')
        self.theme = os.getenv('BADOOGLE_CONFIG_THEME', 'system')
        self.safe = read_config_bool('BADOOGLE_CONFIG_SAFE')
        self.dark = read_config_bool('BADOOGLE_CONFIG_DARK')  # deprecated
        self.alts = read_config_bool('BADOOGLE_CONFIG_ALTS')
        self.nojs = read_config_bool('BADOOGLE_CONFIG_NOJS')
        self.tor = read_config_bool('BADOOGLE_CONFIG_TOR')
        self.near = os.getenv('BADOOGLE_CONFIG_NEAR', '')
        self.new_tab = read_config_bool('BADOOGLE_CONFIG_NEW_TAB')
        self.view_image = read_config_bool('BADOOGLE_CONFIG_VIEW_IMAGE')
        self.get_only = read_config_bool('BADOOGLE_CONFIG_GET_ONLY')
        self.anon_view = read_config_bool('BADOOGLE_CONFIG_ANON_VIEW')
        self.preferences_encrypted = read_config_bool('BADOOGLE_CONFIG_PREFERENCES_ENCRYPTED')
        self.preferences_key = os.getenv('BADOOGLE_CONFIG_PREFERENCES_KEY', '')
    ...
    def preferences(self) -> str:
        ...
        # used by other badoogle instances
    ...
    def to_params(self, keys: list = []) -> str:
        """Generates a set of safe params for using in Badoogle URLs
