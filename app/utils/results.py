...
SITE_ALTS = {
    'twitter.com': os.getenv('BADOOGLE_ALT_TW', 'farside.link/nitter'),
    'youtube.com': os.getenv('BADOOGLE_ALT_YT', 'farside.link/invidious'),
    'reddit.com': os.getenv('BADOOGLE_ALT_RD', 'farside.link/libreddit'),
    **dict.fromkeys([
        'medium.com',
        'levelup.gitconnected.com'
    ], os.getenv('BADOOGLE_ALT_MD', 'farside.link/scribe')),
    'imgur.com': os.getenv('BADOOGLE_ALT_IMG', 'farside.link/rimgo'),
    'wikipedia.org': os.getenv('BADOOGLE_ALT_WIKI', 'farside.link/wikiless'),
    'imdb.com': os.getenv('BADOOGLE_ALT_IMDB', 'farside.link/libremdb'),
    'quora.com': os.getenv('BADOOGLE_ALT_QUORA', 'farside.link/quetre')
}
...
def append_anon_view(result: BeautifulSoup, config: Config) -> None:
    ...
    contents are viewed through Badoogle as a proxy.
